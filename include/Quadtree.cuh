...
namespace jax{
  ...
  */
  ...
  public:
    ...
    */
    ...
    jax::Unity<unsigned int>* dataNodeIndex;
  ...
  */
  ...
  __global__ void getKeys(unsigned int numLocalizedPointers, jax::LocalizedData<unsigned int>* localizedPointers, int* keys, float2* nodeCenters, uint2 size, unsigned int depth);
